...
REQUIRED_FILES = [
    ...
    "tools/verify_operating_contract.py", "tools/verify_github_review.py",
    "tools/trusted_review_gate.py", ".github/workflows/review-gate.yml",
    ".github/workflows/trusted-review-gate.yml",
